            ...
            <div className='w-full lg:flex md:flex grid grid-cols-1 gap-12'>
                <div className='lg:w-2/3 md:w-2/3 w-full'>
                    ...
                    <div>
                        ...
                        <p className='text-2xl font-bold my-5' style={{ color: '#1d2746' }}>Install Sylius via SSH</p>
                    ...
                    <div className='my-16'>
                        <p className='text-2xl font-bold mb-10' style={{ color: '#1d2746' }}>2 - Comments</p>
                        <div>
                            <div className='flex gap-5 justify-center my-12 w-full'>
                                ...
                                <div className='w-11/12'>
                                    <div>
                                        <p className='text-base font-medium' style={{ color: '#1d2746' }}>Issac Wise</p>
                            ...
                            <div className='flex gap-5 justify-center my-12 w-full'>
                                ...
                                <div className='w-11/12'>
                                    <div>
                                        <p className='text-base font-medium' style={{ color: '#1d2746' }}>Chauffina Carr</p>
                                        <p className='text-sm' style={{ color: '#6b707f' }}>July 3, 2022 at 2:14 pm</p>
                                    </div>
                                    <div className='mt-5'>
                                        <p className='text-base' style={{ color: '#6b707f' }}>
                        ...
                        <div className='mb-12 mt-24'>
                            ...
                            <form onSubmit={handleSubmit(onSubmit)}>
                                <div className='flex mb-5 gap-5'>
                                    <input {...register("fullName")} placeholder='Full Name *' className='w-full bg-slate-100 outline-none px-5 py-2 rounded-md' />
                                    <input {...register("email")} placeholder='Email *' className='w-full bg-slate-100 outline-none px-5 py-2 rounded-md' />
                                </div>
