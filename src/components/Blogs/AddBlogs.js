        ...
        <div className=" m-12 mx-28 ">
          ...
          >
            <input
              ...
              required
              placeholder="Image"
              className="w-full bg-lime-50  border-2 px-5 py-2 rounded-md mb-3"
            />
            <input
            ...
            <input
              type="submit"
              className="text-white my-6 ml-72 align-items-center justify-content-center font-bold text-2xl px-5 py-2 rounded-xl gap-2 bg-gradient-to-r hover:bg-gradient-to-l from-teal-600 to-teal-300 cursor-pointer w-56"
              value="Submit Blog"
            />
          </form>
        </div>
...
//       </div>
//       <div className="m-28">
//         <input className="my-5 border-2"  type="text" onChange={getBlogData} /> <br />
//         <input className="my-5 border-2" type="text" onChange={getBlogData} /> <br />
//         <input className="my-5 border-2" type="text" onChange={getBlogData} /> <br />
//         <button className="my-5" onClick={() => setPrint(true)} class="btn ">
//           Add Blog{" "}
//         </button>
//         {
//           print?
//           <h2 className="text-3xl">{blogData}</h2>
//           :null
//         }
//       </div>
//     </div>
