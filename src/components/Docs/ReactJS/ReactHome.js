...
const ReactHome = () => {
    return (
        <section style={{
            ...
            <div className=''>
                <h1 className='text-primary text-center text-5xl lg:text-7xl font-bold mt-28 lg:mt-20 pt-28'>React</h1>
                ...
                <div className='flex justify-center items-center mt-20 mb-12 lg:mb-24'>
                    <Link to='/reactDashboard'><button className='btn btn-primary hover:bg-white pt-6 py-12  lg:px-12 text-lg lg:text-xl  rounded'>Get Started</button></Link>
