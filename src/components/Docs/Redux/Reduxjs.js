    ...
    return (
        <div>
            ...
            <div className=''>
                ...
                <div className='grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-5 max-w-7xl mx-auto text-center my-24'>
                    <div className=' lg:mx-0 md:mx-5 mx-5 bg-white border-cyan-400 border-t-8 border-b-8 shadow-md p-5 rounded-xl transition-all hover:shadow-xl hover:shadow-cyan-300 grid justify-items-center'>
                        {/* <div className='inline-block text-7xl ' style={{ 'color': '#0FCFEC' }}><TiTick /></div> */}
                    ...
                    <div className=' lg:mx-0 md:mx-5 mx-5  bg-white border-cyan-400 border-t-8 border-b-8 shadow-md p-5 rounded-xl transition-all hover:shadow-xl hover:shadow-cyan-300 grid justify-items-center'>
                        ...
                        <div>
                            <h1 className='text-2xl font-bold mb-5'>Debuggable</h1>
                            <p className='text-lg text-left'>The Redux DevTools make it easy to trace when, where, why, and how your application's state changed.</p>
                        </div>
                    </div>
                    <div className=' lg:mx-0 md:mx-5 mx-5  bg-white border-cyan-400 border-t-8 border-b-8 shadow-md p-5 rounded-xl transition-all hover:shadow-xl hover:shadow-cyan-300 grid justify-items-center'>
