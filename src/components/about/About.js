                            ...
                            <div className='flex justify-center items-center gap-5'>
                                ...
                                <div>
                                    ...
                                    <div className='flex items-center gap-3 mt-3'>
                                        <a className='text-xl text-gray-500 hover:text-sky-800' href="https://web.facebook.com/jubaeribnzahir/" target="_blank"><FaFacebookF /></a>
                                        <a className='text-xl text-gray-500 hover:text-sky-800' href="https://www.linkedin.com/in/jubaer-ibn-zohir-9471841aa" target="_blank"><FaLinkedinIn /></a>
                                        <a className='text-xl text-gray-500 hover:text-sky-800' href="https://github.com/jubaer-ibn-johir" target="_blank"><FaGithub /></a>
                                    </div>
                                </div>
                            </div>
                            <div className='flex justify-center items-center gap-5'>
                                ...
                                <div>
                                    ...
                                    <div className='flex items-center gap-3 mt-3'>
                                        <a className='text-xl text-gray-500 hover:text-sky-800' href="https://www.facebook.com/profile.php?id=100010324115694" target="_blank"><FaFacebookF /></a>
                                        <a className='text-xl text-gray-500 hover:text-sky-800' href="https://www.linkedin.com/in/rakibul-hasan-sohag-90b207231/" target="_blank"><FaLinkedinIn /></a>
                                        <a className='text-xl text-gray-500 hover:text-sky-800' href="https://github.com/Rakibulhasan70" target="_blank"><FaGithub /></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className='lg:flex md:flex grid grid-cols-1 justify-center items-center lg:gap-5 md:gap-5 gap-10 lg:mx-0 md:mx-3 mx-3'>
                            <div className='flex justify-center items-center gap-5'>
                                ...
                                <div>
                                    ...
                                    <div className='flex items-center gap-3 mt-3'>
                                        <a className='text-xl text-gray-500 hover:text-sky-800' href="https://www.facebook.com/saifulislam1hridoy" target="_blank"><FaFacebookF /></a>
                                        <a className='text-xl text-gray-500 hover:text-sky-800' href="https://www.linkedin.com/in/saifulislam1hridoy" target="_blank"><FaLinkedinIn /></a>
                                        <a className='text-xl text-gray-500 hover:text-sky-800' href="https://www.github.com/saifulislamhridoy" target="_blank"><FaGithub /></a>
                                    </div>
                                </div>
                            </div>
                            <div className='flex justify-center items-center gap-5'>
                                ...
                                <div>
                                    ...
                                    <div className='flex items-center gap-3 mt-3'>
                                        <a className='text-xl text-gray-500 hover:text-sky-800' href="https://www.facebook.com/naeem141" target="_blank"><FaFacebookF /></a>
                                        <a className='text-xl text-gray-500 hover:text-sky-800' href="https://www.linkedin.com/in/naeem141/" target="_blank"><FaLinkedinIn /></a>
                                        <a className='text-xl text-gray-500 hover:text-sky-800' href="https://github.com/JannatunNaeem141" target="_blank"><FaGithub /></a>
                                    </div>
                                </div>
                            </div>
                        </div>
