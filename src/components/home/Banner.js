    ...
    return (
        <div class="hero h-96 lg:h-4/5 banner flex justify-center items-center" style={{ "backgroundImage": `url(${bannerImg})`, 'backgroundPosition': 'center', 'backgroundRepeat': 'no-repeat' }}>
            ...
            <div class="hero-content text-center text-neutral-content ">
                <div class="">
                    <h1 class="mb-3 text-3xl md:text-4xl lg:text-5xl font-semibold tracking-wider text-white">Knowledge Base</h1>
                    <p class="mb-5 text-white text-xl">We're here to help. Get in touch and we'll get back to you as soon as we can</p>
