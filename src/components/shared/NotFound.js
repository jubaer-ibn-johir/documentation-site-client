...
//                 <div class="container">
//                     <h1 className='notfoundheading'>Ooops! Sorry,<br /> Page Not found </h1>
//                 </div>
            ...
            <div className="col-sm-12 ">
              <div className="col-sm-10 col-sm-offset-1  text-center">
                <div className="four_zero_four_bg">
                  <h1 className="text-center mt-16 ">Not Found</h1>
                </div>

                <div className="contant_box_404">
                  <h3 className="text-xl font-bold">Look like you're lost</h3>

                  <p className="text-xl font-bold">the page you are looking for not avaible at the moment!</p>

                 
                  <button className="mt-2 font-bold"> <Link to='/'>Go to Home</Link></button>
                </div>
              </div>
            </div>
          </div>
